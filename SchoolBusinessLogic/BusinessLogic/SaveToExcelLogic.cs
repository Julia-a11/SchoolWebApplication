...
//                SharedStringTablePart shareStringPart = spreadsheetDocument.WorkbookPart
//                    .GetPartsOfType<SharedStringTablePart>().Count() > 0 ? spreadsheetDocument.WorkbookPart
//                    .GetPartsOfType<SharedStringTablePart>().First() : spreadsheetDocument.WorkbookPart
...
//                uint rowIndex = 2;
//                foreach (var pc in info.Lessons)
//                {
//                    InsertCellInWorksheet(new ExcelCellParameters
//                    {
//                        Worksheet = worksheetPart.Worksheet,
...
//                    foreach (var secure in pc.Societies)
//                    {
//                        InsertCellInWorksheet(new ExcelCellParameters
//                        {
//                            Worksheet = worksheetPart.Worksheet,
...
//            cellParameters.ShareStringPart.SharedStringTable.AppendChild(
//                new SharedStringItem(new Text(cellParameters.Text)));
